  ...
  return (
    <div className="fixed inset-0 -z-10 overflow-hidden">
        ...
        <>
          ...
          <div
            ...
            style={{
              ...
              top: '45%',
              right: '5%',
              background: `radial-gradient(circle, oklch(0.75 0.03 ${hue + 40 > 360 ? hue + 40 - 360 : hue + 40} / 3%) 0%, transparent 70%)`,
              filter: 'blur(100px)',
            }}
          />
        </>
      ...
      <div
        ...
        style={{
          background: isDark
            ? `radial-gradient(ellipse at center, transparent 50%, oklch(0.04 0.02 ${hue + 10} / 20%) 100%)`
            : 'radial-gradient(ellipse at center, transparent 60%, oklch(0.92 0.005 260 / 15%) 100%)',
        }}
      />
    </div>
  );
