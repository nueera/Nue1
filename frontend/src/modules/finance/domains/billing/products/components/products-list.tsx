...
import type { BillingProductStatus, BillingProduct } from '../types';
...
export function ProductsList({ data, isLoading, onRowClick, onEdit, onDelete, onCreateNew }: ProductsListProps) {
  ...
  return (
    <div className="space-y-3">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2">
        ...
        {onCreateNew && (
          <Button onClick={onCreateNew} className="w-full sm:w-auto"><Plus className="h-4 w-4 mr-1" />New Product</Button>
        )}
      </div>
