    ...
    <div className="glass-surface border border-glass-border rounded-2xl p-6">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div><label className="text-xs text-muted-foreground mb-1 block">Shipment Date</label><input {...register('shipmentDate')} type="date" className="w-full px-3 py-2 rounded-lg border border-glass-border bg-glass-bg text-foreground text-sm outline-none focus:border-emerald-500/50" /></div>
        </div>
