    ...
    <div className="glass-surface border border-glass-border rounded-2xl p-6">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <AccessibleField label="Vendor" required error={errors.vendorId?.message}>
            <input {...register('vendorId')} className="w-full px-3 py-2 rounded-lg border border-glass-border bg-glass-bg text-foreground text-sm outline-none focus:border-emerald-500/50" />
          </AccessibleField>
