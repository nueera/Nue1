...
import type { Money, EstimateStatus } from '../../../types/finance-common';
import type { Estimate } from './types';

interface EstimateListProps {
  data: Estimate[];
  isLoading?: boolean;
  onRowClick?: (item: Estimate) => void;
  onEdit?: (item: Estimate) => void;
...
export function EstimateList({ data, isLoading, onRowClick, onEdit, onDelete, onCreateNew }: EstimateListProps) {
  ...
  return (
    <div className="space-y-3">
      <div className="flex items-center justify-between gap-2">
        ...
        {onCreateNew && <Button onClick={onCreateNew}><Plus className="h-4 w-4 mr-1" />New Estimate</Button>}
      </div>
