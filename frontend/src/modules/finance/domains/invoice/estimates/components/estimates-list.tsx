...
export function EstimatesList({ data, isLoading, onRowClick, onEdit, onDelete, onCreateNew }: EstimatesListProps) {
  ...
  return (
    <div className="space-y-3">
      <div className="flex items-center justify-between gap-2">
        ...
        {onCreateNew && (
          <Button onClick={onCreateNew}><Plus className="h-4 w-4 mr-1" />New Estimate</Button>
        )}
      </div>
