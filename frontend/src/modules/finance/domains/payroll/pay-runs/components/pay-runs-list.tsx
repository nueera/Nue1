...
interface PayRunsListProps {
  data: PayRun[];
  isLoading?: boolean;
  onRowClick?: (item: PayRun) => void;
  onEdit?: (item: PayRun) => void;
  onDelete?: (item: PayRun) => void;
  onCreateNew?: () => void;
}
...
export function PayRunsList({ data, isLoading, onRowClick, onEdit, onDelete, onCreateNew }: PayRunsListProps) {
  ...
  return (
    <div className="space-y-3">
      <div className="flex items-center justify-between gap-2">
        ...
        {onCreateNew && (
          <Button onClick={onCreateNew}><Plus className="h-4 w-4 mr-1" />New PayRun</Button>
        )}
      </div>
