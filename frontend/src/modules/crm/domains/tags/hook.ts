...
export function useTags(params?: Record<string, string | number | boolean | undefined>) {
  return useQuery({ queryKey: tagsKeys.list(params || {}), queryFn: () => tagsService.getAll(params) });
}
