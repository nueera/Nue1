...
import { getStageLabel, getStageColor, formatDealValue } from '../utils';
...
export function DealList({ data, isLoading, onRowClick, onEdit, onDelete, onCreateNew }: DealListProps) {
  ...
  const columns = useMemo<ColumnDef<Deal>[]>(() => [
    {
      ...
      cell: ({ row }) => (
        <div>
          <p className="font-medium text-foreground">{row.original.dealName}</p>
    ...
    },
    {
      ...
      cell: ({ getValue }) => {
        ...
        return <span className="text-sm font-medium text-foreground">{formatDealValue(amount)}</span>;
      },
    },
    {
      accessorKey: 'stage',
    ...
    },
    {
      ...
      cell: ({ getValue }) => {
        ...
        return <span className="text-sm text-muted-foreground">{prob}%</span>;
      },
    },
    {
