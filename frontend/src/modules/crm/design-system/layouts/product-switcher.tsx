...
const PRODUCT_ITEMS: ProductMeta[] = [
  { product: 'sales', label: 'Sales', icon: Handshake },
  { product: 'engagement', label: 'Engagement', icon: Activity },
  { product: 'automation', label: 'Automation', icon: Workflow },
  { product: 'analytics', label: 'Analytics', icon: BarChart3 },
  { product: 'platform', label: 'Platform', icon: Puzzle },
];
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        ...
        >
          <div className="flex items-center justify-center w-6 h-6 rounded-md bg-module-crm/15 text-module-crm shrink-0">
          ...
          return (
            <DropdownMenuItem
              ...
              className={cn(
                ...
                isActive
                  ? 'bg-module-crm/10 text-module-crm'
            ...
            >
              <div
                className={cn(
                  ...
                  isActive
                    ? 'bg-module-crm/15 text-module-crm'
              ...
              {isActive && (
                <motion.div
                  layoutId="product-switcher-active-crm"
                  className="ml-auto w-1.5 h-1.5 rounded-full bg-module-crm"
